...
public class productController {
   ...
   private String saveImage(MultipartFile image) throws Exception {
    ...
    System.out.println("✅ Image saved at: " + file.getAbsolutePath()); // ✅ Log
    System.out.println("✅ Image path returned: /uploads/" + fileName); // ✅ Log
    ...
    // ✅ رفع الصورة للمنتج - ارجع المنتج الكامل
    ...
    public ResponseEntity<?> uploadProductImage(
        ...
        try {
            ...
            return ResponseEntity.ok(updatedProduct); // ✅ ارجع المنتج الكامل مع الصورة
        } catch (Exception e) {
            e.printStackTrace();
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error: " + e.getMessage());
